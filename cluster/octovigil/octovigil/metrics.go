...
func (m *commonMetrics) atAuthorizationRequestStart() {
	m.ActiveRequests.Add(context.Background(), 1, metric.WithAttributeSet(m.CommonAttributeSet))
}

func (m *commonMetrics) atAuthorizationRequestEnd(startTime time.Time, additionalAttrSet metric.MeasurementOption) {
