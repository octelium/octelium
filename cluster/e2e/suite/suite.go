...
func Phases() []Phase {
	return []Phase{
		...
		{"AuthenticationRefresh", testAuthenticationRefresh},
		...
		{"VigilSecretManager", testVigilSecretManager},
		{"VigilLoadBalancer", testVigilLoadBalancer},
		{"VigilDNS", testVigilDNS},
		{"VigilSSH", testVigilSSH},
		{"VigilPostgres", testVigilPostgres},
		{"VigilHeaderForgery", testVigilHeaderForgery},
		{"VigilModeSwitch", testVigilModeSwitch},
		{"VigilTLSSwitch", testVigilTLSSwitch},
		...
		{"ConnectPublish", testConnectPublish},
		{"ConnectServe", testConnectServe},
		{"ConnectESSH", testConnectESSH},
		{"ConnectESOCKS5", testConnectESOCKS5},
		{"ConnectIPMode", testConnectIPMode},
		{"ConnectImplementation", testConnectImplementation},
		{"DNSResolution", testDNSResolution},
		{"ConnectLocalDNS", testConnectLocalDNS},
		{"Apply", testApply},
		{"VigilMySQL", testVigilMySQL},
