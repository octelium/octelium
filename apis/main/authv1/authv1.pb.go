...
var file_authv1_proto_rawDesc = []byte{
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x06, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x22, 0xda,
	0x01, 0x0a, 0x24, 0x41, 0x75, 0x74, 0x68, 0x65, 0x6e, 0x74, 0x69, 0x63, 0x61, 0x74, 0x65, 0x57,
	...
	0x5a, 0x0a, 0x11, 0x63, 0x68, 0x61, 0x6c, 0x6c, 0x65, 0x6e, 0x67, 0x65, 0x52, 0x65, 0x73, 0x70,
	0x6f, 0x6e, 0x73, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2c, 0x2e, 0x6f, 0x63, 0x74,
	0x65, 0x6c, 0x69, 0x75, 0x6d, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x6d, 0x61, 0x69, 0x6e, 0x2e, 0x61,
	0x75, 0x74, 0x68, 0x2e, 0x76, 0x31, 0x2e, 0x43, 0x68, 0x61, 0x6c, 0x6c, 0x65, 0x6e, 0x67, 0x65,
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x52, 0x11, 0x63, 0x68, 0x61, 0x6c, 0x6c, 0x65,
	0x6e, 0x67, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0xcf, 0x0e, 0x0a, 0x0b,
...
var file_authv1_proto_msgTypes = make([]protoimpl.MessageInfo, 44)
var file_authv1_proto_goTypes = []any{
	...
	(*RegisterAuthenticatorBeginRequest_PreChallenge)(nil),               // 40: octelium.api.main.auth.v1.RegisterAuthenticatorBeginRequest.PreChallenge
	(*RegisterAuthenticatorBeginResponse_ChallengeRequest)(nil),          // 41: octelium.api.main.auth.v1.RegisterAuthenticatorBeginResponse.ChallengeRequest
	(*RegisterAuthenticatorBeginResponse_ChallengeRequest_FIDO)(nil),     // 42: octelium.api.main.auth.v1.RegisterAuthenticatorBeginResponse.ChallengeRequest.FIDO
	(*RegisterAuthenticatorBeginResponse_ChallengeRequest_TOTP)(nil),     // 43: octelium.api.main.auth.v1.RegisterAuthenticatorBeginResponse.ChallengeRequest.TOTP
	(*Authenticator_Spec)(nil),                                           // 44: octelium.api.main.auth.v1.Authenticator.Spec
	(*Authenticator_Status)(nil),                                         // 45: octelium.api.main.auth.v1.Authenticator.Status
	(*ChallengeResponse_FIDO)(nil),                                       // 46: octelium.api.main.auth.v1.ChallengeResponse.FIDO
	(*ChallengeResponse_TOTP)(nil),                                       // 47: octelium.api.main.auth.v1.ChallengeResponse.TOTP
	(*metav1.ObjectReference)(nil),                                       // 48: octelium.api.main.meta.v1.ObjectReference
	(*metav1.Metadata)(nil),                                              // 49: octelium.api.main.meta.v1.Metadata
	(*metav1.ListResponseMeta)(nil),                                      // 50: octelium.api.main.meta.v1.ListResponseMeta
	(*timestamppb.Timestamp)(nil),                                        // 51: google.protobuf.Timestamp
	(*metav1.GetOptions)(nil),                                            // 52: octelium.api.main.meta.v1.GetOptions
	(*metav1.DeleteOptions)(nil),                                         // 53: octelium.api.main.meta.v1.DeleteOptions
	(*metav1.OperationResult)(nil),                                       // 54: octelium.api.main.meta.v1.OperationResult
}
var file_authv1_proto_depIdxs = []int32{
	...
	48, // 4: octelium.api.main.auth.v1.AuthenticateWithAssertionRequest.identityProviderRef:type_name -> octelium.api.main.meta.v1.ObjectReference
	36, // 5: octelium.api.main.auth.v1.TokenT0.content:type_name -> octelium.api.main.auth.v1.TokenT0.Content
	48, // 6: octelium.api.main.auth.v1.AuthenticateAuthenticatorBeginRequest.authenticatorRef:type_name -> octelium.api.main.meta.v1.ObjectReference
	...
	48, // 8: octelium.api.main.auth.v1.RegisterAuthenticatorBeginRequest.authenticatorRef:type_name -> octelium.api.main.meta.v1.ObjectReference
	40, // 9: octelium.api.main.auth.v1.RegisterAuthenticatorBeginRequest.preChallenge:type_name -> octelium.api.main.auth.v1.RegisterAuthenticatorBeginRequest.PreChallenge
	41, // 10: octelium.api.main.auth.v1.RegisterAuthenticatorBeginResponse.challengeRequest:type_name -> octelium.api.main.auth.v1.RegisterAuthenticatorBeginResponse.ChallengeRequest
	49, // 11: octelium.api.main.auth.v1.Authenticator.metadata:type_name -> octelium.api.main.meta.v1.Metadata
	44, // 12: octelium.api.main.auth.v1.Authenticator.spec:type_name -> octelium.api.main.auth.v1.Authenticator.Spec
	45, // 13: octelium.api.main.auth.v1.Authenticator.status:type_name -> octelium.api.main.auth.v1.Authenticator.Status
	21, // 14: octelium.api.main.auth.v1.AuthenticatorList.items:type_name -> octelium.api.main.auth.v1.Authenticator
	50, // 15: octelium.api.main.auth.v1.AuthenticatorList.listResponseMeta:type_name -> octelium.api.main.meta.v1.ListResponseMeta
	...
	48, // 17: octelium.api.main.auth.v1.RegisterAuthenticatorFinishRequest.authenticatorRef:type_name -> octelium.api.main.meta.v1.ObjectReference
	...
	46, // 19: octelium.api.main.auth.v1.ChallengeResponse.fido:type_name -> octelium.api.main.auth.v1.ChallengeResponse.FIDO
	47, // 20: octelium.api.main.auth.v1.ChallengeResponse.totp:type_name -> octelium.api.main.auth.v1.ChallengeResponse.TOTP
	48, // 21: octelium.api.main.auth.v1.AuthenticateWithAuthenticatorRequest.authenticatorRef:type_name -> octelium.api.main.meta.v1.ObjectReference
	27, // 22: octelium.api.main.auth.v1.AuthenticateWithAuthenticatorRequest.challengeResponse:type_name -> octelium.api.main.auth.v1.ChallengeResponse
	1,  // 23: octelium.api.main.auth.v1.RegisterDeviceBeginRequest.Info.osType:type_name -> octelium.api.main.auth.v1.RegisterDeviceBeginRequest.Info.OSType
	31, // 24: octelium.api.main.auth.v1.RegisterDeviceBeginResponse.Request.command:type_name -> octelium.api.main.auth.v1.RegisterDeviceBeginResponse.Request.Command
	32, // 25: octelium.api.main.auth.v1.RegisterDeviceBeginResponse.Request.file:type_name -> octelium.api.main.auth.v1.RegisterDeviceBeginResponse.Request.File
	34, // 26: octelium.api.main.auth.v1.RegisterDeviceFinishRequest.Response.command:type_name -> octelium.api.main.auth.v1.RegisterDeviceFinishRequest.Response.Command
	35, // 27: octelium.api.main.auth.v1.RegisterDeviceFinishRequest.Response.file:type_name -> octelium.api.main.auth.v1.RegisterDeviceFinishRequest.Response.File
	2,  // 28: octelium.api.main.auth.v1.TokenT0.Content.type:type_name -> octelium.api.main.auth.v1.TokenT0.Content.Type
	51, // 29: octelium.api.main.auth.v1.TokenT0.Content.expiresAt:type_name -> google.protobuf.Timestamp
	38, // 30: octelium.api.main.auth.v1.AuthenticateAuthenticatorBeginResponse.ChallengeRequest.fido:type_name -> octelium.api.main.auth.v1.AuthenticateAuthenticatorBeginResponse.ChallengeRequest.FIDO
	39, // 31: octelium.api.main.auth.v1.AuthenticateAuthenticatorBeginResponse.ChallengeRequest.totp:type_name -> octelium.api.main.auth.v1.AuthenticateAuthenticatorBeginResponse.ChallengeRequest.TOTP
	42, // 32: octelium.api.main.auth.v1.RegisterAuthenticatorBeginResponse.ChallengeRequest.fido:type_name -> octelium.api.main.auth.v1.RegisterAuthenticatorBeginResponse.ChallengeRequest.FIDO
	43, // 33: octelium.api.main.auth.v1.RegisterAuthenticatorBeginResponse.ChallengeRequest.totp:type_name -> octelium.api.main.auth.v1.RegisterAuthenticatorBeginResponse.ChallengeRequest.TOTP
	3,  // 34: octelium.api.main.auth.v1.Authenticator.Status.type:type_name -> octelium.api.main.auth.v1.Authenticator.Status.Type
	13, // 35: octelium.api.main.auth.v1.MainService.AuthenticateWithAuthenticationToken:input_type -> octelium.api.main.auth.v1.AuthenticateWithAuthenticationTokenRequest
	14, // 36: octelium.api.main.auth.v1.MainService.AuthenticateWithAssertion:input_type -> octelium.api.main.auth.v1.AuthenticateWithAssertionRequest
	15, // 37: octelium.api.main.auth.v1.MainService.AuthenticateWithRefreshToken:input_type -> octelium.api.main.auth.v1.AuthenticateWithRefreshTokenRequest
	7,  // 38: octelium.api.main.auth.v1.MainService.Logout:input_type -> octelium.api.main.auth.v1.LogoutRequest
	9,  // 39: octelium.api.main.auth.v1.MainService.RegisterDeviceBegin:input_type -> octelium.api.main.auth.v1.RegisterDeviceBeginRequest
	11, // 40: octelium.api.main.auth.v1.MainService.RegisterDeviceFinish:input_type -> octelium.api.main.auth.v1.RegisterDeviceFinishRequest
	52, // 41: octelium.api.main.auth.v1.MainService.GetAuthenticator:input_type -> octelium.api.main.meta.v1.GetOptions
	24, // 42: octelium.api.main.auth.v1.MainService.CreateAuthenticator:input_type -> octelium.api.main.auth.v1.CreateAuthenticatorRequest
	21, // 43: octelium.api.main.auth.v1.MainService.UpdateAuthenticator:input_type -> octelium.api.main.auth.v1.Authenticator
	23, // 44: octelium.api.main.auth.v1.MainService.ListAuthenticator:input_type -> octelium.api.main.auth.v1.ListAuthenticatorOptions
	53, // 45: octelium.api.main.auth.v1.MainService.DeleteAuthenticator:input_type -> octelium.api.main.meta.v1.DeleteOptions
	19, // 46: octelium.api.main.auth.v1.MainService.RegisterAuthenticatorBegin:input_type -> octelium.api.main.auth.v1.RegisterAuthenticatorBeginRequest
	25, // 47: octelium.api.main.auth.v1.MainService.RegisterAuthenticatorFinish:input_type -> octelium.api.main.auth.v1.RegisterAuthenticatorFinishRequest
	17, // 48: octelium.api.main.auth.v1.MainService.AuthenticateAuthenticatorBegin:input_type -> octelium.api.main.auth.v1.AuthenticateAuthenticatorBeginRequest
	4,  // 49: octelium.api.main.auth.v1.MainService.AuthenticateWithAuthenticationToken:output_type -> octelium.api.main.auth.v1.SessionToken
	4,  // 50: octelium.api.main.auth.v1.MainService.AuthenticateWithAssertion:output_type -> octelium.api.main.auth.v1.SessionToken
	4,  // 51: octelium.api.main.auth.v1.MainService.AuthenticateWithRefreshToken:output_type -> octelium.api.main.auth.v1.SessionToken
	8,  // 52: octelium.api.main.auth.v1.MainService.Logout:output_type -> octelium.api.main.auth.v1.LogoutResponse
	10, // 53: octelium.api.main.auth.v1.MainService.RegisterDeviceBegin:output_type -> octelium.api.main.auth.v1.RegisterDeviceBeginResponse
	12, // 54: octelium.api.main.auth.v1.MainService.RegisterDeviceFinish:output_type -> octelium.api.main.auth.v1.RegisterDeviceFinishResponse
	21, // 55: octelium.api.main.auth.v1.MainService.GetAuthenticator:output_type -> octelium.api.main.auth.v1.Authenticator
	21, // 56: octelium.api.main.auth.v1.MainService.CreateAuthenticator:output_type -> octelium.api.main.auth.v1.Authenticator
	21, // 57: octelium.api.main.auth.v1.MainService.UpdateAuthenticator:output_type -> octelium.api.main.auth.v1.Authenticator
	22, // 58: octelium.api.main.auth.v1.MainService.ListAuthenticator:output_type -> octelium.api.main.auth.v1.AuthenticatorList
	54, // 59: octelium.api.main.auth.v1.MainService.DeleteAuthenticator:output_type -> octelium.api.main.meta.v1.OperationResult
	20, // 60: octelium.api.main.auth.v1.MainService.RegisterAuthenticatorBegin:output_type -> octelium.api.main.auth.v1.RegisterAuthenticatorBeginResponse
	26, // 61: octelium.api.main.auth.v1.MainService.RegisterAuthenticatorFinish:output_type -> octelium.api.main.auth.v1.RegisterAuthenticatorFinishResponse
	18, // 62: octelium.api.main.auth.v1.MainService.AuthenticateAuthenticatorBegin:output_type -> octelium.api.main.auth.v1.AuthenticateAuthenticatorBeginResponse
