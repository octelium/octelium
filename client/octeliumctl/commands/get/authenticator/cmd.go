...
const example = `
octeliumctl get authenticator
octeliumctl get authn
octeliumctl get authenticators -o json
octeliumctl get authenticators -o yaml
octeliumctl get authn --user alice
`
