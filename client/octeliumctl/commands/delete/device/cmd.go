...
var Cmd = &cobra.Command{
	...
	Example: `
octeliumctl delete device example.com/usr1-browser-p4wbr
octeliumctl del dev example.com -n usr1-browser-p4wbr
	`,
...
func init() {
	Cmd.PersistentFlags().StringVarP(&cmdArgs.Name, "name", "n", "", "Device name")
